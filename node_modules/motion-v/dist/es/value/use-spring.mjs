...
import { animateValue } from "../external/.pnpm/motion-dom@12.10.5/external/motion-dom/dist/es/animation/JSAnimation.mjs";
import { motionValue } from "../external/.pnpm/motion-dom@12.10.5/external/motion-dom/dist/es/value/index.mjs";
import { isMotionValue } from "../utils/motion-value.mjs";
import { frame, frameData } from "../external/.pnpm/motion-dom@12.10.5/external/motion-dom/dist/es/frameloop/frame.mjs";
function toNumber(v) {
  if (typeof v === "number")
    return v;
  return parseFloat(v);
